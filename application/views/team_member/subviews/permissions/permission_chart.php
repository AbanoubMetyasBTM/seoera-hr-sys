...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="col-md-12 dash-unit" >
            <dtitle> Permissions Activities </dtitle>
            <hr>
            <?php 
                $all_permissions = 0;
                if (!empty($permissions)) {
                    
                    $all_permissions = intval(count($permissions));
                    
                }
            ?>
            <input type="hidden" class="all" value="<?= $all_permissions ?>">
            <input type="hidden" class="not_accept" value="<?= intval($permissions_not_accepted) ?>">
            <input type="hidden" class="accept" value="<?= intval($permissions_accepted) ?>">
            <div id="permissions_chart" style="width:100%;height: 375px"></div>
        </div>
    ...
    <div class="col-md-3">
        <div class="dash-unit">
            ...
            <form action="<?= base_url('team_member/permissions/permission_chart') ?>" method="POST" style="text-align: center;">
