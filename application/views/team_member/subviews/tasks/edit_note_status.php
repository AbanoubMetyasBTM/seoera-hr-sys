    ...
    <div class="row" style="background-color: #ccc;">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <i class="fa fa-tasks"></i>  <a href="<?=base_url('team_member/tasks')?>"> All Tasks </a>
                </li>
                <li class="active">
                    <?php if (!empty($task)): ?>
                ...
                <div class="panel panel-default" style="padding: 10px">
                    ...
                    <?php
                        ...
                        if (!empty($task)) {
                            ...
                            $task_note_by_user = $task->task_note_by_user;


                        }


                        $labels = array("Task Note By User");
                        $fields = array("task_note_by_user");
                        $required = array("");
                    ...
                    <form method="POST" action="<?=base_url('team_member/tasks/edit_note_status'.$task_id)?>" name="task_form" class="task_form" enctype="multipart/form-data">

                        <div class="form-group form-group-md">

                            <div class="panel panel-primary">

                                <div class="panel-heading">Task Status and Note By User</div>
                        ...
                        <br>
                        <a href="<?=base_url('team_member/tasks')?>" type="button" class="btn btn-default" data-dismiss="modal"> Back <i class="glyphicon glyphicon-backward"></i></a>
