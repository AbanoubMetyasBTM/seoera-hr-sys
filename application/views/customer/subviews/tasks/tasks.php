        ...
        <table id="tasks" class="table table-striped table-responsive table-hover table-bordered task_table" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <?php if (!empty($tasks)): ?>
                    ...
                    <?php foreach ($tasks as $key => $task): ?>
                        ...
                        <tr>
                            ...
                            <td><?= mb_substr($task->task_note_by_user,0,25, "utf-8"); ?></td>
                            <td><?= $task->task_start_date; ?></td>
                            <!--<td><?= $task->task_end_date; ?></td>-->

                            <td>
                                <a href="<?=base_url('customer/tasks/edit_note_status/'.$task->task_id.'')?>" title="Edit Task Note <?= $task->task_title ?>"  id ="<?= $task->task_id ?>">
                ...
                <?php if (empty($tasks)): ?>
                    ...
                    <div class="alert alert-info"> There isn't tasks to you until now keep following...  </div>
